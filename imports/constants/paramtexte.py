...
class Paramtexte(object):
    ...
    cles = ['editing-year', 'editing-month', 'invoice-year', 'invoice-month', 'invoice-version', 'invoice-project',
            ...
            'proj-expl', 'flow-type', 'flow-cae', 'flow-noshow', 'flow-lvr', 'flow-srv', 'item-id', 'item-idsap',
            'item-codeK', 'item-textK', 'item-text2K', 'item-K1', 'item-K1a', 'item-K1b', 'item-K2', 'item-K2a',
            'item-K3', 'item-K3a', 'item-K4', 'item-K4a', 'item-K5', 'item-K5a', 'item-K6', 'item-K6a', 'item-K7',
            'item-K7a', 'item-nbr', 'item-name', 'item-unit', 'item-codeD', 'item-flag-usage', 'item-flag-conso',
            'item-eligible', 'item-order', 'item-labelcode', 'item-extra', 'transac-date', 'transac-raw',
            'transac-quantity', 'transac-valid', 'transac-id-staff', 'transac-staff', 'transac-usage',
