...
class Paramtexte(object):
    ...
    cles = ['invoice-year', 'invoice-month', 'invoice-version', 'invoice-project', 'invoice-id', 'invoice-type',
            'invoice-ref', 'platf-code', 'platf-op', 'platf-name', 'client-code', 'client-sap', 'client-name',
            ...
            'user-name-f', 'proj-id', 'proj-nbr', 'proj-nbr-0', 'proj-name', 'proj-name-0', 'proj-expl', 'flow-type',
            'flow-cae', 'flow-noshow', 'flow-lvr', 'flow-srv', 'item-id', 'item-idsap', 'item-codeK', 'item-textK',
            'item-text2K', 'item-K1', 'item-K1a', 'item-K1b', 'item-K2', 'item-K2a', 'item-K3', 'item-K3a', 'item-K4',
            'item-K4a', 'item-K5', 'item-K5a', 'item-K6', 'item-K6a', 'item-K7', 'item-K7a', 'item-nbr', 'item-name',
            'item-unit', 'item-codeD', 'item-flag-usage', 'item-flag-conso', 'item-eligible', 'item-order',
            'item-labelcode', 'item-extra', 'transac-date', 'transac-quantity', 'transac-valid', 'transac-id-staff',
            'transac-staff', 'transac-usage', 'transac-runtime', 'transac-runcae', 'valuation-price', 'valuation-brut',
            'discount-type', 'discount-HC', 'discount-LVR', 'discount-CHF', 'deduct-CHF', 'valuation-net',
            'valuation-net-cancel', 'valuation-net-notbill', 'subsid-code', 'subsid-name', 'subsid-start', 'subsid-end',
            ...
            'annex-compte-pied-page-g1', 'annex-compte-pied-page-g2', 'fact-A', 'fact-B', 'fact-C', 'fact-D', 'fact-E',
            'fact-F', 'fact-G', 'fact-H', 'fact-I', 'fact-J', 'fact-K', 'fact-L', 'fact-M', 'fact-N', 'fact-O',
            'fact-P', 'fact-Q', 'fact-R', 'fact-S', 'fact-T', 'fact-U', 'fact-V', 'fact-W', 'fact-X', 'fact-Y',
            'fact-Z', 'fact-AA', 'fact-AB', 'fact-AC', 'fact-AD', 'fact-AE', 'fact-AF', 'fact-AG', 'fact-AH', 'fact-AI',
            'fact-AJ', 'fact-AK', 'fact-AL', 'fact-AM', 'fact-AN', 'fact-AO', 'fact-AP', 'fact-AQ', 'fact-AR',
            'fact-AS', 'fact-AT', 'fact-AU', 'fact-AV', 'fact-AW', 'fact-AX', 'fact-AY']
